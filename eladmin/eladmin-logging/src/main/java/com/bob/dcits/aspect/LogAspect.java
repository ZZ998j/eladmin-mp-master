package com.bob.dcits.aspect;

import lombok.extern.slf4j.Slf4j;
import com.bob.dcits.domain.SysLog;
import com.bob.dcits.service.SysLogService;
import com.bob.dcits.utils.RequestHolder;
...
public class LogAspect {
     ...
     * 配置切入点
     */
    @Pointcut("@annotation(com.bob.dcits.annotation.Log)")
